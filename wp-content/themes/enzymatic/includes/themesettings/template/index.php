        ...
        <table class="form-table">
            <tr valign="top">
                ...
                <td>
                    ...
                    <img id="image_logo" width="210" src="<?php echo $images['logo']; ?>"/>
                </td>
            </tr>
            <tr valign="top">
                ...
                <td>
                    ...
                    <img id="image_headercontacticon" width="210" src="<?php echo $images['headercontacticon']; ?>" />
                </td>
            </tr>
            <tr valign="top">
                ...
                <td>
                    ...
                    <img id="image_code" width="210" src="<?php echo $images['code']; ?>" />
                </td>
            </tr>
        </table>
